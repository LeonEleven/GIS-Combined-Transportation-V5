...
public class MainDijkstra {
  ...
  public static void main(String[] args) {
    ...
    nodeList.add(new Node(-2.0, 43587.32515, 0, -2.0, 0));
  ...
  public static List<Node> findOptimalPath(ArrayList<Node> nodeList) {
    ...
    while (!pq.isEmpty()) {
      ...
      // System.out.println("==========进入 nodeList for 循环==========");
      ...
      // System.out.println("==========进入 distances for 循环==========");
      ...
      // System.out.println("==========结束 distances for 循环==========");
      // System.out.println("==========进入 parentNodes for 循环==========");
      for (Map.Entry<Node, Node> entry : parentNodes.entrySet()) {
        Node key = entry.getKey();
      ...
      // System.out.println("==========结束 parentNodes for 循环==========");
      // System.out.println("==========结束 nodeList for 循环==========");
    }

    if (distances.get(endNode) != Double.MAX_VALUE) {
      Node node = endNode;
      // System.out.println("endNode:" + node.id);
      while (node != null) {
  ...
  public static boolean isReachable(Node node1, Node node2) {
    ...
    // System.out.println("isReachable.distance:" + distance);
    // System.out.println("isReachable.sumOfRadii:" + sumOfRadii);
